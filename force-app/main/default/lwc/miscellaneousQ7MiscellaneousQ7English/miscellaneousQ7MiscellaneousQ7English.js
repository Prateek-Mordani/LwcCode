...
import { OMNIDEF } from './miscellaneousQ7MiscellaneousQ7English_def.js';
import tmpl from './miscellaneousQ7MiscellaneousQ7English.html';
import tmpl_nds from './miscellaneousQ7MiscellaneousQ7English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class miscellaneousQ7MiscellaneousQ7English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

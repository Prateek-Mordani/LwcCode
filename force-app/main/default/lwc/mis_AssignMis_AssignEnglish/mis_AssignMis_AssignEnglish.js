...
import { OMNIDEF } from './mis_AssignMis_AssignEnglish_def.js';
import tmpl from './mis_AssignMis_AssignEnglish.html';
import tmpl_nds from './mis_AssignMis_AssignEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class mis_AssignMis_AssignEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
